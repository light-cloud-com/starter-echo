...
<h1 align="center">Echo API Boilerplate</h1>

<p align="center">
  An Echo HTTP service in Go, ready to deploy on Light Cloud.
</p>
...
- Echo v4
- JSON responses with Echo's router and middleware
...
3. Choose **"Echo"** as the framework
